...
- "hook_icon": a Material Symbols Outlined icon name in snake_case that matches the hook theme (e.g. "rocket_launch", "payments", "lightbulb", "trending_up", "psychology", "business", "attach_money", "emoji_objects")
